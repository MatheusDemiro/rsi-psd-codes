...
class Baseline:
    def __init__(self, COLLECTION_PATH, BASELINE_PATH, WINDOW_SIZE):
    ...
    def openFile(self):
        arq = open(self.COLLECTION_PATH, "r+")
        data = arq.readlines()
        arq.close()
    ...
    def execution(self):
        ...
        return self.saveBaseline(windows)  # Salvando janela
